object Version {
    ...
    val Retrofit = "2.6.2"
    val HiltCoreVersion = "2.29.1-alpha"
...
object Hilt {
    val Core = "com.google.dagger:hilt-android:${Version.HiltCoreVersion}"
    val Common = "androidx.hilt:hilt-common:${Version.HiltVersion}"
    val ViewModel = "androidx.hilt:hilt-lifecycle-viewmodel:${Version.HiltVersion}"
    val DaggerHiltCompiler = "com.google.dagger:hilt-compiler:${Version.HiltCoreVersion}"
    val Compiler = "androidx.hilt:hilt-compiler:${Version.HiltVersion}"
}
